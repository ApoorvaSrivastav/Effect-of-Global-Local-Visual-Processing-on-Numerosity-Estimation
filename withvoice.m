...
while true
    ...
    if(trial(k,2)==0)
        ...
        DrawFormattedText(window, 'Focus on the Global Component of the image on the next screen',...
                         'center', 'center', white);
        Screen('Flip', window);
        ...
        Screen(window,'TextSize',20);
        DrawFormattedText(window, 'Focus on the Local Component of the image on the next screen',...
                         'center', 'center', white);
        Screen('Flip', window);
        % Wait for two seconds
        KbStrokeWait;
...
KbStrokeWait;
%% End of Experiment
write(trial,'Subject','csv','Subject.csv');
